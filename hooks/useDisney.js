...
function useDisney(){
    ...
    function addToHistorial(character){
            ...
            setState((state) => ({...state, historial: [...state.historial, newCharacter]}));        
    ...
    function addToFavoritos(character){
        ...
        setState((state) => ({...state, favoritos: [...state.favoritos, newCharacter]}));        
    ...
    return { fetchCharacters, fetchCharacter, getHistorial, addToHistorial, getFavoritos, addToFavoritos, deleteCharacterFromFavoritos}
}
